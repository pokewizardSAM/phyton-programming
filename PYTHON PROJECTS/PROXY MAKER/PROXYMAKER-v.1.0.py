...
absent_teachers_list = []  # Declare as global
            ...
            if reallocation is True:
                ...
                for other_teacher_in_same_period in db_reader:
                    if other_teacher_in_same_period[period_no] == "FREE":
                        ...
                        # save_reallocation_data(period_no,other_teacher_in_same_period[0])
...
# def save_reallocation_data(period_no, value):
...
def main():
    ...
    with open("PROXY MAKE FILE .csv", "r+", newline="") as Teacher_db:
        ...
        next(db_reader)
        absent_teachers(["rahulgautam", "vikassir", "shifamomin", "sumanma'am", "kamyama'am","patilsir","sandeepsir"], db_reader)
