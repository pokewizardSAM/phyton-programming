...
def reward_function(params):
    ...
    x = params["x"]
    y = params["y"]
    time_limit = 60  # 3 minutes in seconds
    ...
    if distance_from_center > track_width/3:
        ...
        final_reward -= distance_from_center * scaling_factor
